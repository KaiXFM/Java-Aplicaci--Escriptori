...
function inici(){    
    ...
    // var botog = document.getElementById('botogratis');
    // var botob = document.getElementById('botobasic');
    // var botop = document.getElementById('botopremium');
    ...
    // botog.addEventListener('click', planselec1);
    // botob.addEventListener('click', planselec2);
    // botop.addEventListener('click', planselec3);
...
function desplegar(){
    ...
    var menu = document.getElementById('blocllista');
    var llista = document.getElementById('llista');
...
function planselec1() {
    ...
    // var botop = document.getElementById("botopremium");
        ...
        // botog.style.display = "flex";
        // botob.style.display = "none";
        // botop.style.display = "none";       
        console.log("click");

        var modalitat2 = 1;

        const url = `perfil.php?dato=${encodeURIComponent(modalitat2)}`;

        // Realizar una redirección a la URL
...
function planselec2() {
    ...
    //     botog.style.display = "none";
    //     botob.style.display = "flex";
    //     botop.style.display = "none";       
    //     console.log("click");
